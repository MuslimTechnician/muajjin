...
const COUNTRIES: Country[] = [
  {
    ...
    cities: [
      ...
      'Comilla', 'Gazipur', 'Narayanganj', 'Mymensingh', 'Jessore', 'Bogra', 
      'Dinajpur', 'Tangail', 'Jamalpur', 'Pabna', 'Nawabganj', 'Kushtia', 
      'Faridpur', 'Cox\'s Bazar', 'Feni', 'Jhenaidah', 'Brahmanbaria', 
      'Saidpur', 'Noakhali', 'Sirajganj', 'Narsingdi', 'Rangamati'
    ]
  },
  {
    name: 'Afghanistan',
  ...
  {
    name: 'Indonesia',
    cities: ['Jakarta', 'Surabaya', 'Bandung', 'Medan', 'Semarang', 'Makassar', 'Palembang', 'Tangerang', 'Depok', 'Padang']
  },
  {
    name: 'Iran',
  ...
  {
    name: 'Kuwait',
    cities: ['Kuwait City', 'Hawalli', 'Salmiya', 'Al Ahmadi', 'Sabah as Salim']
  },
  {
    name: 'Lebanon',
  ...
  {
    name: 'Malaysia',
    cities: ['Kuala Lumpur', 'George Town', 'Ipoh', 'Shah Alam', 'Johor Bahru', 'Kuching', 'Penang', 'Kota Kinabalu', 'Melaka', 'Kota Bharu']
  },
  {
    name: 'Morocco',
  ...
  {
    name: 'Pakistan',
    cities: ['Karachi', 'Lahore', 'Islamabad', 'Faisalabad', 'Rawalpindi', 'Multan', 'Hyderabad', 'Peshawar', 'Quetta', 'Sialkot']
  },
  {
    name: 'Philippines',
  ...
  {
    name: 'Saudi Arabia',
    cities: ['Riyadh', 'Jeddah', 'Mecca', 'Medina', 'Dammam', 'Taif', 'Tabuk', 'Buraydah', 'Khamis Mushait', 'Abha']
  },
  {
    name: 'Singapore',
    cities: ['Singapore']
