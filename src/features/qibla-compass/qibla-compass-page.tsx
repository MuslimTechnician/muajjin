...
const getContinuousAngle = (nextAngle: number, previousAngle: number) =>
  previousAngle + normalizeSignedDegrees(nextAngle - previousAngle);

const extractHeadingFromOrientationEvent = (
...
const smoothHeading = (nextHeading: number, previousHeading: number) => {
...
const calculateDistanceToKaaba = (latitude: number, longitude: number) => {
